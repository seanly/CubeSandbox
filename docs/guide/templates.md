...
- To inspect template build status and preview the effective request, see [Template Inspection and Request Preview](./template-inspection-and-request-preview.md).
...
- [Creating CubeSandbox-Compatible Templates](./creating-compatible-templates.md) — why plain images are not enough and how to build a compatible image.
- [Template Inspection and Request Preview](./template-inspection-and-request-preview.md) — how to inspect template status and preview the effective request.
